...
public class UpdateActivity2 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mhelper=new MyDBOpenHelper(UpdateActivity2.this);//实例化数据库帮助类对象
    ...
    private void btnQuery() {
        btn_threequery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor cursor=db.rawQuery("select * from stu_info2 where sno=?",new String[]{edit_threeinputsno.getText().toString()});
                if(cursor.getCount()!=0){
                    Toast.makeText(UpdateActivity2.this,"查询成功",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(UpdateActivity2.this,"没有查询到该条支出",Toast.LENGTH_SHORT).show();
    ...
    private void btnModify() {
        btn_threemodify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.update("stu_info2",values,"sno=?",new String[]{edit_threesno.getText().toString()});
                Toast.makeText(UpdateActivity2.this,"修改成功",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
