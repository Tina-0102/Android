...
public class DeleteActivity2 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mhelper=new MyDBOpenHelper(DeleteActivity2.this);//实例化数据库帮助类对象
    ...
    private void btnDelete() {
        btn_fourdelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.delete("stu_info2","sno=?",new String[]{edit_foursno.getText().toString()});
                Toast.makeText(DeleteActivity2.this,"删除成功",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
